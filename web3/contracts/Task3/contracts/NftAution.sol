...
/**
 *  NFT拍卖合约
 *  实现NFT 的拍卖功能，支持ETH和ERC20参与竞拍，价格以USD计价，
 *  集成chainLink预言机获取实时价格，使用UUPS升级模式
 **/
...
contract NftAuction is Initializable, UUPSUpgradeable {
    ...
    struct Auction {
        ...
        address payToken;
        // 工厂合约地址，用于调用工厂合约的相关函数（如计算手续费，把手续费转给平台）
        address factory;
        // 拍卖ID
